...
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports SEL0]; #IO_L4N_T0_34 Sch=sw[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports SEL1]; #IO_L9P_T1_DQS_34 Sch=sw[3]
